...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        try:
            ...
            preprocessor = Pipeline(steps=[('Imputer', simple_imputer), # replace missing values with 0
                                           ('RobustScaler', robust_scalar)]) # keep every feature in the same range and handle outlier
            return preprocessor
        except Exception as e:
            raise SensorException(e, sys)
